...
public class AchievementsServlet extends javax.servlet.http.HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException{
        ...
        RequestDispatcher dispatcher=request.getRequestDispatcher("/achievements.jsp"); //Same thing as main screen, loads into inventory, but I want it to load the Java then the JSP
        dispatcher.forward(request, response);
    }
